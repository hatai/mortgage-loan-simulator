...
export function LoanSection({
  ...
  return (
    <div className="rounded-xl bg-card shadow-sm border-l-4 border-l-purple-500 p-5">
      <h2 className="text-sm font-semibold text-purple-600 dark:text-purple-400 mb-4 uppercase tracking-wide">
        ローン条件
      </h2>
              ...
              <button
                ...
                className={`flex-1 py-1.5 text-sm font-medium transition-colors ${
                  ...
                  interestType === type
                    ...
                    : "bg-card text-foreground hover:bg-purple-50 dark:hover:bg-purple-900/20"
                }`}
              >
              ...
              <button
                ...
                className={`py-1.5 px-2 text-xs font-medium rounded-md border transition-colors ${
                  energyPerformance === opt.value
                    ...
                    : "bg-card text-foreground border-input hover:bg-purple-50 dark:hover:bg-purple-900/20"
                }`}
              >
                {opt.label}
              </button>
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 ${
              isChildRearingHousehold ? "bg-purple-500" : "bg-gray-200 dark:bg-gray-700"
            }`}
          >
            <span
